...
local _Replicator = TS.import(script, game:GetService("ServerScriptService"), "DataStore", "Replicator")
local ServerReplicator = _Replicator.default
local ServerResponseBuilder = _Replicator.ServerResponseBuilder
